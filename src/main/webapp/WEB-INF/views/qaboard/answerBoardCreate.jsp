...
<div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
    <h2 class="mb-4 text-xl font-bold text-gray-900">답변 게시글</h2>
    <form name="answerboardCreateFrm" method="post">
        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="memberNo" id="memberNo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="${loginMember.memberNo}" required readonly>
...
<script src="${pageContext.request.contextPath}/js/qaboard/answerboardCreate.js"></script>